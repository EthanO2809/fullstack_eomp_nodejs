<template>
  <div class="about">
    ...
    <div class="user-picture">
        <img src="https://i.postimg.cc/8zstgbtv/Screenshot-2023-05-03-100656.png" alt="" class="img-01">
    </div>
    <p class="name-client"> Ganiefah Majiet
        <span>CEO & CO-FOUNDER
        </span>
    </p>
    ...
    <p class="name-client"> Ethan Oliver
        <span>CEO & CO-FOUNDER
        </span>
    </p>
    ...
    <div class="officialsponsors">
      ...
      <!-- NIKE -->
      <img src="https://i.postimg.cc/hjQYP0mQ/Screenshot-2023-08-23-123023-removebg-preview.png" alt="" class="logos mb-4">

      <!-- ADIDAS -->
      <img src="https://i.postimg.cc/rwpQwJXy/Screenshot-2023-08-23-122952-removebg-preview.png" alt="" class="logos mb-4">

      <!-- PUMA -->
      <img src="https://i.postimg.cc/L651q0XW/Screenshot-2023-08-23-122850-removebg-preview.png" alt="" class="logos mb-4">

      <!-- JORDAN -->
      <img src="https://i.postimg.cc/cCMXrkLC/Screenshot-2023-08-23-123057-removebg-preview.png" alt="" class="logos mb-4">
...
export default {
  data() {
    return {
      aboutText:
        "Welcome to Sole Cartel! At Sole Cartel, we're more than just a sneaker retailer. We're a community of sneaker enthusiasts who are passionate about providing you with the latest and most sought-after footwear. Our journey began with a simple idea: to create a platform where sneakerheads of all kinds could come together to explore, share, and acquire the sneakers they love.",
    };
  },
};
</script>
